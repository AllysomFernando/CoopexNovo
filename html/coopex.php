...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-BEEZ3DYHXP"></script>
    <script>
...
<body class="mod-bg-1 ">
        ...
        <div class="page-inner">
            ...
            <div class="page-content-wrapper">
                ...
                if (isset($_GET['diretorio3'])) {
                    ...
                    $id_tipo_usuario = $_SESSION['coopex']['usuario']['sistema']['id_tipo_usuario'];
                    switch ($id_tipo_usuario) {
                        case 6:
                            include_once("modulos/dashboard/academico/academico.php");
                            break;
                        case 10:
                            include_once("modulos/dashboard/coordenacao/vestibular.php");
                            break;
                        case 21:
                        case 9:
                            include_once("modulos/dashboard/direcao/matriculas.php");
                            break;
                        case 22:
                            include_once("modulos/colegio/painel.php");
                            break;
                        default:
    ...
    if ($_SESSION['coopex']['usuario']['id_faculdade'] == 1000000006) {
    ?>
        <style>
            .page-logo,
            .page-sidebar,
