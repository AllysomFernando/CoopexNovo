...
#########################################################################################
	...
	#arquivo de emissao
	$assinatura = '/portal/httpd/htdocs/registro_bradesco/retorno_bradesco/assinatura/'.$dt_emissao.'_'.date('H-i-s').'-'.$cpf.'.txt';
	$arquivo_emissao = '/portal/httpd/htdocs/registro_bradesco/retorno_bradesco/'.$dt_emissao.'_'.date('H-i-s').'-'.$cpf.'.txt';
    ...
    $certificado_pfx = file_get_contents('/portal/httpd/htdocs/vestibular/inscricao/certificados/fag1.pfx');
