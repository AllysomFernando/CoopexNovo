...
<main id="js-page-content" role="main" class="page-content naoimprimir">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item active">Reofertas por Curso</li>
		<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
	</ol>
	<div class="subheader">
		<h1 class="subheader-title">
			<i class='subheader-icon fal fa-credit-card-front'></i> REOFERTAS POR CURSO<sup class='badge badge-primary fw-500'>NOVO</sup>
			<small>
				Relatório de pagamentos de reofertas por curso
			</small>
		</h1>
	</div>
