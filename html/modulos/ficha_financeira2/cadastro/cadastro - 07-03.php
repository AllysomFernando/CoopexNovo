<?php session_start();
	...
	if($dados->total_diciplinas_pacote){
...
<main id="js-page-content" role="main" class="page-content">
	...
	<form class="needs-validation" novalidate="" method="post" target="dados" action="modulos/ficha_financeira/cadastro/cadastro_dados.php">
										...
										<table id="diciplinas_pacote" class="table table-bordered table-hover table-striped w-100">
											...
											<tfoot>
												<tr style="background-color: #ddd">
													...
													<td class="text-center">
														<input onkeyup="definir_carga_horaria_pacote()" class="form-control text-center" <?= isset($_GET) && $personalizado ? "" : "readonly"?>  type="text" name="total_diciplinas_pacote" id="total_diciplinas_pacote" value="<?= isset($_GET) && $personalizado ? $dados->total_diciplinas_pacote : 0?>">
			  ...
			  <div id="panel-2" class="panel">
				<div class="panel-hdr">
					...
					<div class="panel-container show">
						...
						<?
							if(isset($_GET['id']) && ($_SESSION['coopex']['usuario']['sistema']['id_tipo_usuario'] == 10 || $_SESSION['coopex']['usuario']['sistema']['id_tipo_usuario'] == 12 || $_SESSION['coopex']['usuario']['sistema']['id_tipo_usuario'] == 1)){
						?>
...
<script>
	...
	function definir_equivalencia(id_disciplina, id_equivalente, ch, id_unidade_responsavel){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/definir_equivalencia.php", {id_disciplina: id_disciplina, id_equivalente: id_equivalente, ch: ch, id_unidade_responsavel, id_unidade_responsavel})
		.done(function(json){
			if(json){
	...
	function definir_valor_mensalidade_fisioterapia(){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/definir_valor_mensalidade_fisioterapia.php", {valor_desconto: valor_desconto})
		.done(function(json){
			if(json){
				carrega_valor_ficha();
			}
	...
	function definir_turma(id_disciplina, id_classe = ''){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/definir_turma.php", {id_disciplina: id_disciplina, id_classe: id_classe})
		.done(function(json){
	...
	function definir_carga_horaria_pacote(){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/definir_carga_horaria_pacote.php", {total_horas: total_horas})
		.done(function(json){
			carrega_valor_ficha();
		})
		.fail(function(jqxhr, textStatus, error) {
	...
	function tornar_dp(id_disciplina){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/tornar_dp.php", {id_disciplina: id_disciplina, id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>})
		.done(function(json){
	...
	function clonar(){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/clonar.php", {id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>})
		.done(function(json){
	...
	function carrega_pacote(id_turma = ''){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/disciplina_pacote.php", {id_semestre: id_semestre, id_pessoa: id_pessoa, id_periodo: id_periodo, id_curso: id_curso, id_turma: id_turma, id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>})
		.done(function(json){
	...
	function horario(id_disciplina, id_classe){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/consulta_horario.php", {id_semestre: id_semestre, id_disciplina: id_disciplina, id_classe: id_classe})
		.done(function(json){
			console.dir(json);
	...
	function incluir_disciplina_fora(id){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/disciplina_fora_pacote_inclusao.php", {id_disciplina: id, id_pessoa: id_pessoa, id_curso: id_curso, id_semestre: id_semestre})
		.done(function(json){
	...
	function enviar_para_coordenacao(){
		var obs = $("#obs").val();
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/enviar_para_coordenacao.php", {id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>, obs: obs})
			.done(function(json){
				Swal.fire({
					type: "success",
	...
	function notificar_aluno_tesouraria_email(){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/notificar_aluno_tesouraria_email.php", {id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>, email: contato_email})
			.done(function(json){
				$('#default-example-modal-lg-center').modal('toggle');
				Swal.fire({
					type: "success",
	...
	function encaminhar_cres(){
		var email = $("#email").val();
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/encaminhar_cres.php", {id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>})
			.done(function(json){
				Swal.fire({
					type: "success",
	...
	function aguardando_dp(){
		var email = $("#email").val();
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/aguardando_dp.php", {id_ficha_financeira: <?=isset($_GET['id']) ? $_GET['id'] : 0?>})
			.done(function(json){
				Swal.fire({
					type: "success",
					title: "Status definido com sucesso",
