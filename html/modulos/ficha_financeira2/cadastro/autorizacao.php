                    ...
                    <div class="input-group input-group-lg bg-white shadow-inset-2">
                        ...
                        <div class="input-group-append">
                        	<?
                        		...
                        		if($_SESSION['coopex']['usuario']['sistema']['id_tipo_usuario'] == 3){
                        	?>
                        	 	<a href="#" onclick="notificar_aluno_tesouraria()" class="btn btn-default waves-effect waves-themed" type="button">Enviar</a>
                        	<?		
                        		} else {
                        	?>
...
<script>
	...
	function alterar_link_whatsapp(id_registro = ''){
		...
		texto += "<?= urlencode("Declaração de aceite para alteração de disciplinas e previsão de mensalidades:\n
