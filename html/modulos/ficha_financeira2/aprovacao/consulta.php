							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 100px" class="text-center">
										...
										<a href="ficha_financeira/<?=$row2->id_etapa == 7 ? "aprovacaovalor" : "aprovacao"?>/<?php echo $row->id_ficha_financeira?>" class="btn btn-success btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-pencil"></i></a>
