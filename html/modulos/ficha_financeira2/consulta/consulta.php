...
<form id="form_excluir_registro" method="post" target="dados" action="modulos/ficha_financeira2/cadastro/cadastro_dados.php">
...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		...
		<div class="subheader-title col-6 text-right">
			<a href="ficha_financeira2/cadastro">
			  	...
			  	<div id="panel-2" class="panel">
					...
					<script type="text/javascript">
						function selecionar_semestre(){
							...
							window.location.href = "https://coopex.fag.edu.br/ficha_financeira2/consulta/"+semestre;
						}
					</script>
							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 100px" class="text-center">
										...
										?>
										<a href="ficha_financeira2/cadastro/<?php echo $row->id_ficha_financeira?>" class="btn btn-success btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-pencil"></i></a>
										<?php
											}
										?>
										
										<?php
											if((isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][4]) ||  $_SESSION['coopex']['usuario']['sistema']['id_tipo_usuario'] == 2 ) && $row2->id_etapa < 3){
										?>
