...
<?php
	...
	$tabela  = "colegio.big_jump_meia"; //TABELA PRINCIPAL
	$chave	 = "id_big_jump_meia"; //CAMPO CHAVE DA TABELA
	$valor_unidade = 20;
	...
	if($_POST){
		...
		$_POST['valor'] = $valor_unidade;
		$_POST['total'] = $valor_unidade * $_POST['quantidade'];
