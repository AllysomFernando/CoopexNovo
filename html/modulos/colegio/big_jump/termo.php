...
<main id="js-page-content" role="main" class="page-content">
	...
	<ol class="breadcrumb page-breadcrumb">
		<li class="breadcrumb-item"><a href="javascript:void(0);">Big Jump</a></li>
	...
	<div class="subheader">
		<h1 class="subheader-title">
			<i class='subheader-icon fal fa-repeat'></i> Big Jump
			<small>
		...
		<div class="d-flex flex-start w-100">
			...
			<div class="d-flex flex-fill">
				<div class="flex-fill">
					...
					<h3>NORMAS FLY/BIG JUMP – COLÉGIO FAG</h3>
					<ol>
						<li>Antes de pular, todos os usuários precisam estar com este termo de autorização oficial do Big Jump Colégio FAG, autorizado pelos pais e/ou responsáveis;</li>
					...
					<ol>
						...
						<li>É Obrigatório o uso de meias antiderrapantes para o brinquedo. <strong>(CASO NÃO POSSUA MEIAS
								ANTIDERRAPANTES, ELAS PODEM SER ADQUIRIDAS NA SEÇÃO ABAIXO).</strong></li>
					</ol>
								...
								<div class="col-md-12 mb-3">
									...
									?>
										<div class="panel-tag">
											...
											regras para a correta prática da atividade denominada "BIG JUMP",
											<strong>AUTORIZANDO</strong> o menor abaixo qualificado a praticar tal
											atividade, me responsabilizando pelo mesmo, para habilitar a aturorização é necessário clicam em <strong>"Li e concordo com os termos de autorização"</strong> na seção acima.
										</div>
									<?php
									} else {
									?>
								...
								<form class="col-12 p-2" method="post" target="dados" action="modulos/colegio/big_jump/autorizar.php">
									<div class="row">
										<div class="col-xl-8 mb-3">
											<label class="form-label">Aluno(a) Autorizado(a)</label>
											<input style="text-transform: uppercase" require type="text"  class="form-control form-control-lg required" value="<?= utf8_encode($_SESSION['coopex']['usuario']['nome']) ?>" disabled>
										</div>
										<div class="col-xl-5 mb-3">
											<label class="form-label" for="responsavel">Nome do Responsável</label>
											<input style="text-transform: uppercase" require type="text" id="responsavel" name="responsavel" class="form-control form-control-lg required" value="<?= isset($row->responsavel) ? $row->responsavel : "" ?>" disabled>
										</div>
										<div class="col-xl-3 mb-3">
											<label class="form-label" for="cpf">CPF do Responsável</label>
											<input data-inputmask="'mask': '999.999.999-99'" require type="text" id="cpf" name="cpf" class="form-control form-control-lg" value="<?= isset($row->cpf) ? $row->cpf : "" ?>" disabled>
										</div>
				...
				<div class="panel-container show">
					<div class="panel-content p-0">
						<div class="panel-content">
							...
							<div class="form-row form-group">
								<form class="needs-validation col-12 p-2" novalidate="" method="post" target="dados" action="modulos/colegio/big_jump/comprar.php">
									...
									<div class="row">
										...
										<div class="col-2 mb-3">
											...
											<select require type="text" id="id_tamanho" name="id_tamanho" class="form-control form-control-lg required" <?= $autorizado ? "" : "disabled" ?> >
												<option value="1">P</option>
												<option value="2">M (34-36)</option>
												<option value="3">G (37-40)</option>
												<option value="3">GG (40-43)</option>
											</select>
										</div>
										...
										?>
											<div class="col-4 mb-3">
												<label class="form-label">&nbsp</label><br>
												<a target="_blank" href="https://coopex.fag.edu.br/boleto/big_jump/<?=$id_pessoa?>" class="btn btn-lg btn-primary btn-lg waves-effect waves-themed" <?= $autorizado ? "" : "disabled" ?>>
...
<script>
	...
	function matriculaFalha(operacao) {
		var msg = "Não foi possível realizar o Pedido";
		Swal.fire({
			type: "error",
			title: msg,
			showConfirmButton: false,
