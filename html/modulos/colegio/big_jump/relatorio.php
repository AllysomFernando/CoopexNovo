...
<ol class="breadcrumb page-breadcrumb">
	...
	<li class="breadcrumb-item active">Autorização</li>
	<li class="position-absolute pos-top pos-right d-none d-sm-block"><code>ID: 01</code></li>
</ol>
<div class="subheader">
	<h1 class="subheader-title">
		<i class='subheader-icon fal fa-barcode-read'></i> Autorização por Aluno
...
$('#select2-ajax').on('select2:select', function (e) {
	...
	console.log(data.id);
	$("#titulos_em_aberto_resultado").load("modulos/colegio/big_jump/ajax/consulta_autorizacao.php?id_usuario="+data.id);
