		...
		<div class="d-flex flex-start w-100">
			...
			<div class="d-flex flex-fill">
				<div class="flex-fill">
					...
					<h4><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/horario3.pdf"><strong>VEJA O CRONOGRAMA COMPLETO</strong></a></h4>
					...
					<h3><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/contrato_v2.pdf"><strong>LEIA O CONTRATO DA ESCOLA DE ESPORTES</strong></a></h3>
												...
												<tr>
													...
													<th>
														<div class="custom-control custom-checkbox">
															<input <?= (isset($row->id_sports) && $res2->rowCount()) ? "checked" : "" ?> <?= $check ?> name="id_modalidade[]" value="<?= $row3->id_modalidade ?>,<?= $vagas_restantes ?>" type="checkbox" class="custom-control-input check_modalidade" id="modalidade<?= $row3->id_modalidade ?>">
															<label class="custom-control-label" for="modalidade<?= $row3->id_modalidade ?>"> <?= $vagas_restantes > 0 ? "Reservar vaga" : "Incluir na fila de espera"; ?></label>
														</div>
													</th>
												</tr>
											<?
												...
												<table class="table">
													...
													?>
														<tr>
															...
															<td>
																<div class="custom-control custom-checkbox">
																	<input <?= $vagas_restantes <= 0 ? "disabled" : "" ?> onclick="carrega_valor()" <?= isset($row->id_sports) && $res2->rowCount() && $vagas_restantes > 0 ? "checked" : "" ?> name="id_modalidade_matricula[]" value="<?= $row3->id_modalidade ?>" type="checkbox" class="custom-control-input check_modalidade" id="id_modalidade_matricula<?= $row3->id_modalidade ?>" <?= $matricula ? 'disabled' : '' ?>>
