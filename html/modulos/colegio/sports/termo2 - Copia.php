								...
								<form class="col-12 p-2" method="post" target="dados" action="modulos/colegio/sports/inscricao_dados_matricula.php">
									...
									<table class="table">
										...
										<tr style="background-color: #DCDCDC;">
											...
											<td align="right"><strong>R$ <span id="subtotal">0,00</span></strong></td>
										</tr>
										<tr style="background-color: #D3D3D3;">
											<td align="right">DESCONTO DE SEGUNDA MODALIDADE</td>
											<td align="right"><strong>R$ <span id="desconto">0,00</span></strong></td>
										</tr>
										<tr style="background-color: #C0C0C0;">
											<td align="right">TOTAL MENSAL</td>
											<td align="right"><strong>R$ <span id="mensal">0,00</span></strong></td>
										</tr>
									...
									<table class="table">
										<tr>
											...
											<td align="right"><strong>VALOR DA PARCELA</strong></td>
											<td align="right"><strong>VALOR TOTAL</strong></td>
										</tr>
										<tr>
											<td>
												<div class="custom-control custom-radio">
													<input <?= $matricula ? 'disabled' : ''?> <?=$row_matricula->parcela == 1 ? 'checked' : ''?> value="1" type="radio" class="custom-control-input" id="defaultUncheckedRadio" name="id_plano">
													<label class="custom-control-label" for="defaultUncheckedRadio">ANUAL</label>
												</div>
											</td>
											<td align="center">1x</td>
											<td align="center">10%</td>
											<td align="right"><strong>R$ <span id="parcela_anual">0,00</span></strong></td>
											<td align="right"><strong>R$ <span id="total_anual">0,00</span></strong></td>

										</tr>
										<tr>
											<td>
												<div class="custom-control custom-radio">
													<input <?= $matricula ? 'disabled' : ''?> <?=$row_matricula->parcela == 2 ? 'checked' : ''?> value="2"  type="radio" class="custom-control-input" id="defaultUncheckedRadio2" name="id_plano">
													<label class="custom-control-label" for="defaultUncheckedRadio2">SEMESTRAL</label>
												</div>
											</td>
											<td align="center">2x</td>
											<td align="center">5%</td>
											<td align="right"><strong>R$ <span id="parcela_semestral">0,00</span></strong></td>
											<td align="right"><strong>R$ <span id="total_semestral">0,00</span></strong></td>

										</tr>
										<tr>
											<td>
												<div class="custom-control custom-radio">
													<input <?= $matricula ? 'disabled' : ''?> <?=$row_matricula->parcela == 3 ? 'checked' : ''?> value="3" type="radio" class="custom-control-input" id="defaultUncheckedRadio3" name="id_plano">
													<label class="custom-control-label" for="defaultUncheckedRadio3">MENSAL</label>
												</div>
											</td>
											<td align="center">10x</td>
											<td align="center">0%</td>
											<td align="right"><strong>R$ <span id="parcela_mensal">0,00</span></strong></td>
											<td align="right"><strong>R$ <span id="total_mensal">0,00</span></strong></td>
									...
									<div class="row">
										<div class="col-4 mb-3">
											...
											<br>
											<?php if (!$matricula) { ?>
												<button id="botao_matricula" type="submit" class="btn btn-lg btn-primary waves-effect waves-themed" disabled>
													<span class="fal fa-lock mr-1"></span>
													Matricular
												</button>
												<?php } else {
