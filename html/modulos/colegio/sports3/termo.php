		...
		<div class="d-flex flex-start w-100">
			...
			<div class="d-flex flex-fill">
				<div class="flex-fill">
					...
					<h3 class="mt-5 d-none">CRONOGRAMA</h3>
					...
					<h4 class="d-none"><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/horario3.pdf"><strong>VEJA O CRONOGRAMA COMPLETO</strong></a></h4>



					<h3 class="mt-5">VALORES</h3>
					<ul>
						<li>R$ 200,00 mensais por modalidade (A participação de público externo fica condicionada à indicação de um aluno do Colégio FAG.).</li>

					</ul>


					<h3><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/contrato.pdf"><strong>LEIA O CONTRATO DA ESCOLA DE ESPORTES</strong></a></h3>
								...
								<form class="col-12 p-2" method="post" target="dados" action="modulos/colegio/sports/pre_matricular.php">
									...
									<div class="row">
										<div class="col-xl-5 mb-3">
											...
											<input style="text-transform: uppercase" required type="text" id="responsavel" name="responsavel" class="form-control form-control-lg required" disabled value="<?= isset($row->responsavel) ? utf8_encode($row->responsavel) : "" ?>" />
										</div>
									...
									<div class="row">
										<div class="col-xl-3 mb-4">
											...
											<input type="text" class="form-control form-control-lg" value="R$ 120,00" disabled />
										</div>
										...
										<div class="col-xl-2 mb-3">
											...
											<div class="mt-1"><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/camiseta.pdf">Ver grade de tamanhos</a> </div>
									...
									<div class="row">
										<a class="col-xl-6 col-md-6" href="modulos/colegio/sports/images/camiseta_cinza.jpg" target="_blank"><img width="100%" src="modulos/colegio/sports/images/camiseta_cinza.jpg"></a>
										<a class="col-xl-6 col-md-6" href="modulos/colegio/sports/images/camiseta_azul.jpg" target="_blank"><img width="100%" src="modulos/colegio/sports/images/camiseta_azul.jpg"></a>
									</div>
									<div>*Imagens ilustrativas</div>

									<h3 class="mt-4">MODALIDADE</h3>
					...
					<div class="panel-content p-0">
						<div class="panel-content">
							<div class="form-row form-group">
								...
								<form id="form_atestado" class="col-12 p-2" method="post" target="dados" action="modulos/colegio/sports/inscricao_dados_atestado.php" enctype="multipart/form-data">

									<h3 id="atestado_aptidao">ATESTADO DE APTIDÃO FÍSICA</h3>
									<label class="form-label">De acordo com o constante no Item 2.1.1. do Contrato de Prestação de Serviços Desportivos, é exigida, para a efetivação da matrícula e participação nas atividades desportivas, a apresentação de atestado médico comprovando a aptidão física do(a) aluno(a), <strong>o qual deve ser anexado no presente momento (abaixo)</strong>. O atestado médico em questão será submetido à apreciação do Coordenador da Escola de Esportes em até 05 dias úteis e, em sendo aprovado, restará autorizado o prosseguimento do processo de matrícula.</label>
									...
									if ($atestado) {
										if ($row_atestado->extensao == "sec") {
									?>
											<h3 class="mt-4">Atestado disponível na secretaria</h3>
										...
										?>
											<h3 class="mt-4"><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/atestado/<?= $row_atestado->id_atestado . "." . $row_atestado->extensao ?>">Visualizar atestado anexado</a></h3>
											<div class="panel-tag mt-4">
												Atestado enviado em:
												<strong><?php echo converterDataHora($row_atestado->data_atestado); ?></strong><br>
											</div>
									...
									?>
										...
										<br>
										<button onclick="validarFormulario()" id="botao_atestado" type="button" class="btn btn-lg btn-primary waves-effect waves-themed mt-4">
					...
					<div class="panel-content p-0">
						<div class="panel-content">
							<div class="form-row form-group">
								...
								<form class="col-12 p-2" method="post" target="dados" action="modulos/colegio/sports/inscricao_dados_matricula_externo.php">
									<h3 class="mt-4">MODALIDADES</h3>
									<label class="form-label">De acordo com o constante na Cláusula Quinta do Contrato de Prestação de Serviços Desportivos, o(a) representante legal do(a) aluno(a) poderá, a qualquer momento, rescindir o contrato unilateralmente, ficando obrigado(a) ao pagamento das mensalidades em atraso e a do mês em vigência, bem como da multa rescisória correspondente à 01 mensalidade da modalidade escolhida. Ademais, na eventualidade de a turma da modalidade esportiva selecionada não alcançar o número mínimo de alunos estabelecido contratualmente, o contrato restará automaticamente rescindido.</label>
									<table class="table">
										<tr>
											<th>Modalidade</th>
										...
										?>
											<tr>
												...
												<td align="right">R$ <?= number_format($row3->valor_externo, 2, ',', '.') ?></td>
												<td>
													<div class="custom-control custom-checkbox">
														<input onclick="carrega_valor()" name="id_modalidade_matricula[]" value="<?= $row3->id_modalidade ?>" type="checkbox" class="custom-control-input check_modalidade" id="id_modalidade_matricula<?= $row3->id_modalidade ?>" <?= $matricula ? 'disabled' : '' ?>>
														<label class="custom-control-label" for="id_modalidade_matricula<?= $row3->id_modalidade ?>">Matricular</label>
													</div>
												</td>
											</tr>
										<?
									...
									<div class="row">
										<div class="col-12 mb-3">
											...
											?>
												<hr>
												<label class="form-label" for="nome_camiseta">A emissão e o respectivo fornecimento dos boletos bancários para pagamento das mensalidades dar-se-ão tão somente após a devida inscrição do(a) aluno e o cumprimento da totalidade dos requisitos exigidos no Contrato de Prestação de Serviços Desportivos. A matrícula do(a) aluno(a) restará formalizada através do pagamento da mensalidade, de acordo com a modalidade e a quantidade de esportes optada.</label>
												...
												<table class="table">
													...
													?>
														<tr>
															<td><?= $row->parcela ?></td>
															<td>R$ <?= number_format($row->valor_externo, 2, ',', '.') ?></td>
															...
															<td>
																...
																?>
																	<a target="_blank" href="https://coopex.fag.edu.br/boleto/sports/matricula/<?= $row->id_matricula_boleto ?>" class="btn btn-lg btn-primary waves-effect waves-themed" <?= $row->pago || $atestado == 0 ? "disabled" : "" ?>>
																		<span class="fal <?= $row->pago ? "fa-check" : "fa-print" ?> mr-1"></span>
																		<?= $row->pago ? "Pago" : "Gerar Boleto" ?>
																	</a>
																<?
...
<script>
	...
	function matriculaOK(id_matricula) {
		...
		Swal.fire({
			...
			timer: 1500,
			onClose: () => {
				$.getJSON("php/registro_bradesco/sports_matricula_parcelamento_externo.php", {
						id: id_matricula
					})
					.done(function(json) {
						location.reload();
	...
	function carrega_valor() {
		...
		if (ids.length) {
			$.getJSON("modulos/colegio/sports/ajax/carrega_valor_externo.php", {
					id_modalidade: ids
				})
				.done(function(json) {
					res = json[0];
