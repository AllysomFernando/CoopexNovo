...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title col-6">
			<i class='subheader-icon fal fa-repeat'></i> Planejamento
			<small>
		...
		<div class="subheader-title col-6 text-right">
			<a href="/colegio/sports/planejamento/cadastro">
					...
					<div class="panel-content">
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							<tbody>
								...
								?>
								<tr>
									<td class="pointer"><a href="colegio/sports/planejamento/cadastro/<?php echo $row->id_planejamento?>"><?php echo texto($row->modalidade)?></a></td>
									<td class="pointer"><?php echo converterData($row->data_cadastro)?></td>
									<td style="width: 70px">
										<?php
											if(isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][3])){
										?>
										<a href="colegio/sports/planejamento/cadastro/<?php echo $row->id_planejamento?>" class="btn btn-sm btn-icon btn-outline-success rounded-circle mr-2" title="Editar Registro">
										...
										?>
										<a href="javascript:excluir_registro('colegio.planejamento', 'id_entrada', <?php echo $row->id_entrada?>)" class="btn btn-sm btn-icon btn-outline-danger rounded-circle" title="Excluir Registro">
