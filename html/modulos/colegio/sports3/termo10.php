...
<main id="js-page-content" role="main" class="page-content">
		...
		<div class="d-flex flex-start w-100">
			...
			<div class="d-flex flex-fill">
				<div class="flex-fill">
					...
					<h4><a target="_blank" href="https://coopex.fag.edu.br/arquivos/colegio/sports/horario2.pdf"><strong>VEJA O CRONOGRAMA COMPLETO</strong></a></h4>
	...
	<iframe class="d-nones" name="dados" src="" style="position: fixed; z-index: 999999999999; width: 100%; background-color: #fff; top: 0; left: 0; height: 300px"></iframe>
							...
							<div class="panel-content p-0">
								<div class="panel-content">
									<div class="form-row form-group">
										...
										<form id="form_atestado" class="col-12 p-2" method="post" target="dados" action="modulos/colegio/sports/inscricao_dados_atestado10.php" enctype="multipart/form-data">
