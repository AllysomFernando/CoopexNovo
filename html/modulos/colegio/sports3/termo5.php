...
if ($res->rowCount()) {
	...
	$atestado = $row->atestado ? true : false;
}
						...
						<div class="panel-content">
							<div class="form-row form-group">
								...
								<form class="col-12 p-2" method="post" target="dados"
									...
									<input type="text" name="id_curso" value="<?= $row_aluno->id_curso ?>">
									<input type="text" name="id_turno" value="<?= $row_aluno->id_turno ?>">
									<input type="text" name="id_serie" value="<?= $row_aluno->id_serie ?>">
									...
									<div class="">
										<table class="table">
											...
											while ($row3 = $res3->fetch(PDO::FETCH_OBJ)) {
												...
												$vagas_restantes = $row_vaga->total - $row_vaga->vagas;
												//echo "<hr>";
												?>
												<tr>
													<th><?= utf8_encode($row3->modalidade) ?></th>
													<th class="text-center">
														<?= $vagas_restantes > 0 ? $vagas_restantes : 0; ?></th>
													<th>
														<div class="custom-control custom-checkbox">
															<input <?= (isset($row->id_sports) && $res2->rowCount()) ? "checked" : "" ?> 	<?= !isset($row->id_sports) || $vagas_restantes < 1 ? "disabled" : "" ?>
																name="id_modalidade[]"
							...
							<div class="panel-content p-0">
								<div class="panel-content">
									<div class="form-row form-group">
										...
										<form onsubmit="return validarFormulario()" class="col-12 p-2" method="post"
											target="dados" action="modulos/colegio/sports/inscricao_dados_matricula.php"
...
<script>
	function validarFormulario() {
		...
		var elementoAncora = document.getElementById("atestado_aptidao");
