						...
						<div class="panel-content p-0">
							<div class="panel-content">
								...
								<div class="form-row">
									...
									<div class="col-md-4">
										<label class="form-label" for="validationCustom03">Mês <span class="text-danger">*</span></label>
										
										<select  name="mes" class="select2 form-control" required="">
											<option value="">Selecione o Mês</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 1 ? 'selected=""' : ''?> value="1">Janeiro</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 2 ? 'selected=""' : ''?> value="2">Fevereiro</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 3 ? 'selected=""' : ''?> value="3">Março</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 4 ? 'selected=""' : ''?> value="4">Abril</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 5 ? 'selected=""' : ''?> value="5">Maio</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 6 ? 'selected=""' : ''?> value="6">Junho</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 7 ? 'selected=""' : ''?> value="7">Julho</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 8 ? 'selected=""' : ''?> value="8">Agosto</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 9 ? 'selected=""' : ''?> value="9">Setembro</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 10 ? 'selected=""' : ''?> value="10">Outubro</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 11 ? 'selected=""' : ''?> value="11">Novembro</option>
											<option <?=isset($dados->id_pessoa) && $dados->mes == 12 ? 'selected=""' : ''?> value="12">Dezembro</option>
										</select>
