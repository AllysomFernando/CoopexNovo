...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title col-6">
			...
			<small>
				Autorização de Mudança de Matrícula
			</small>
		</h1>

		<div class="subheader-title col-6 text-right">
			<a href="ficha_financeira/autorizacao">
							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 100px" class="text-center">
										...
										?>
										<a href="ficha_financeira/autorizacao/<?php echo $row->id_autorizacao?>" class="btn btn-success btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-pencil"></i></a>
										<?php
											}
										?>
										<a href="javascript:excluir_registro('ficha_financeira.autorizacao', 'id_autorizacao', <?php echo $row->id_autorizacao?>)" class="btn btn-danger btn-icon rounded-circle waves-effect waves-themed"><i class="fal fa-times"></i></a>
									</td>
								</tr>
								<?php
									}
