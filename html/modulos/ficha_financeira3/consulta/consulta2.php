<?php
	...
	if(isset($_GET['id'])){
		$id_semestre = $_GET['id'];
		$etapa = "and ficha_financeira.id_etapa = ".$_GET['id'];
	} else {
		$etapa = "";
	}
	...
	$sql = "SELECT
			...
			FROM
				...
				INNER JOIN ficha_financeira.etapa on etapa.id_etapa = ficha_financeira.id_etapa 
			WHERE
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							<tbody>
								...
								<tr>
									...
									<td><span class="badge badge-<?php echo $row2->cor;?> badge-pill"><?php echo texto($row->etapa);?></span></td>
