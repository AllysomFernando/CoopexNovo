...
<ol class="breadcrumb page-breadcrumb">
	...
	<li class="breadcrumb-item active">Raio-x</li>
	<li class="position-absolute pos-top pos-right d-none d-sm-block"><code>ID: 01</code></li>
</ol>
<div class="subheader">
	<h1 class="subheader-title">
		<i class='subheader-icon fal fa-search'></i> Raio-X
		<small>
			Raio-X
		</small>
	</h1>
			...
			<div class="panel-container show">
				<div class="panel-content">
					<div class="form-group">
						...
						<select onChange="" data-placeholder="Digite o nome..." class="js-consultar-usuario form-control" id="select2-ajax"></select>
					</div>
...
$('#select2-ajax').on('select2:select', function (e) {
	...
	console.log(data.id);
	$("#titulos_em_aberto_resultado").load("modulos/coopex/raiox/ajax/raiox.php?id_usuario="+data.id);
