...
if ($method == "POST" && isset($_GET['id'])) {
  ...
  try {
    $response = $controller->setFinalizado($id_ticket);
    ...
    $email_data['ticket_status'] = 'Solucionado';
    ...
    echo json_encode(array('erro' => "Ocorreu um erro ao atualizar o ticket", "stack" => $th));
    exit;
  }
