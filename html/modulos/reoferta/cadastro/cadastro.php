...
<main id="js-page-content" role="main" class="page-content">
	...
	<form class="needs-validation" novalidate="" method="post" target="dados"
		action="modulos/reoferta/cadastro/cadastro_dados.php">
							...
							<div class="panel-content">
								<div class="form-row">
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom03">Período da Reoferta<span
										...
										?>
										<select <?php echo $desabilitar_edicao ? 'disabled=""' : "" ?> id="id_periodo"
											name="id_periodo" class="select2 form-control" required="">
											...
											while ($row = $periodo->fetch(PDO::FETCH_OBJ)) {
												...
												?>
												<option <?php echo isset($dados->id_periodo) ? $selecionado : "" ?> 	<?php echo !$row->ativo ? "disabled" : "" ?>
													value="<?php echo $row->id_periodo ?>"><?php echo $row->periodo ?>
								...
								<div class="form-row">
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Inicio da Pré-Matrícula <span
												class="text-danger"></span></label>
										<input readonly="" type="text" name="pre_inscricao_data_inicial_fixo"
											class="form-control" id="pre_inscricao_data_inicial_fixo" placeholder=""
											value="">
									</div>
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Fim da Pré-Matrícula <span
												class="text-danger"></span></label>
										<input readonly="" type="text" class="form-control"
											name="pre_inscricao_data_final_fixo" id="pre_inscricao_data_final_fixo"
											placeholder="" value="">
									</div>
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Inicio da Matrícula <span
												class="text-danger"></span></label>
										<input readonly="" type="text" class="form-control"
											name="inscricao_data_inicial_fixo" id="inscricao_data_inicial_fixo"
											placeholder="" value="">
									</div>
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Fim da Matrícula <span
												class="text-danger"></span></label>
										<input readonly="" type="text" class="form-control"
											name="inscricao_data_final_fixo" id="inscricao_data_final_fixo"
											placeholder="" value="">
									</div>
								</div>
								<hr>
								<div class="form-row form-group">
									<div class="col-md-6 mb-3">
										<div class="custom-control custom-switch">
											<input type="hidden" id="select_periodo_diferente_hidden"
												name="periodo_diferente"
												value="<?php echo isset($dados->periodo_diferente) && $dados->periodo_diferente ? "true" : "false" ?>">
											<input disabled=""
												onchange="$('#select_periodo_diferente_hidden').val(this.checked)" <?php echo isset($dados->periodo_diferente) && $dados->periodo_diferente ? "checked" : "" ?> contenteditable="" type="checkbox"
												class="custom-control-input is-invalid" id="select_periodo_diferente">

											<label class="custom-control-label" for="select_periodo_diferente">Utilizar
												período diferente do pré-definido</label>
										</div>
									</div>
								</div>
								<div class="form-row form-group">
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Inicio da Pré-Matrícula <span
												class="text-danger">*</span></label>
										<input data-inputmask="'mask': '99/99/9999'" disabled type="text"
											class="form-control periodo_diferente" name="pre_inscricao_data_inicial"
											placeholder=""
											value="<?php echo isset($dados->periodo_diferente) && $dados->periodo_diferente == 1 ? converterData($dados->pre_inscricao_data_inicial) : "" ?>">
									</div>
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Fim da Pré-Matrícula <span
												class="text-danger">*</span></label>
										<input data-inputmask="'mask': '99/99/9999'" disabled type="text"
											class="form-control periodo_diferente" name="pre_inscricao_data_final"
											placeholder=""
											value="<?php echo isset($dados->periodo_diferente) && $dados->periodo_diferente == 1 ? converterData($dados->pre_inscricao_data_final) : "" ?>">
									</div>
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Inicio da Matrícula <span
												class="text-danger">*</span></label>
										<input data-inputmask="'mask': '99/99/9999'" disabled type="text"
											class="form-control periodo_diferente" name="inscricao_data_inicial"
											placeholder=""
											value="<?php echo isset($dados->periodo_diferente) && $dados->periodo_diferente == 1 ? converterData($dados->inscricao_data_inicial) : "" ?>">
									</div>
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom02">Fim da Matrícula <span
												class="text-danger">*</span></label>
										<input data-inputmask="'mask': '99/99/9999'" disabled type="text"
											class="form-control periodo_diferente" name="inscricao_data_final"
											placeholder=""
											value="<?php echo isset($dados->periodo_diferente) && $dados->periodo_diferente == 1 ? converterData($dados->inscricao_data_final) : "" ?>"
											required>
									</div>
								</div>
							</div>
							...
							<div class="panel-content">
								<div class="form-row">
									<div class="col-md-4 mb-3">
										<label class="form-label" for="validationCustom03">Curso <span
												class="text-danger">*</span></label>
										<?php
										...
										?>
										<select <?php echo $desabilitar_edicao_carga_horaria || $desabilitar_edicao ? 'disabled=""' : "" ?> id="id_curso" name="id_departamento"
											...
											while ($row = $curso->fetch(PDO::FETCH_OBJ)) {
												...
												?>
												<option <?php echo isset($dados->id_departamento) ? $selecionado : "" ?>
													value="<?php echo $row->id_departamento ?>">
								...
								<div class="form-row">
									<div class="col-md-4 mb-3">
										<label class="form-label" for="validationCustom03">Disciplina <span
												class="text-danger">*</span></label>
										<select <?php echo $desabilitar_edicao_carga_horaria || $desabilitar_edicao ? 'disabled=""' : "" ?> id="id_disciplina" name="id_disciplina"
											onchange="$('#disciplina').val($(this).select2('data')[0].text);"
											disabled="" class="select2 form-control" required="">
											<option value="">Selecione a Disciplina</option>
										</select>
										<input type="hidden" name="disciplina" id="disciplina"
											value="<?php echo isset($dados->disciplina) ? utf8_encode($dados->disciplina) : "" ?>">
										<div class="invalid-feedback">
											Selecione a disciplina
										</div>
									</div>
									<div class="col-md-4 mb-3">
										<label class="form-label" for="validationCustom02">Carga Horária Original da
											Disciplina</label>
										<input readonly="" type="text" class="form-control"
											id="carga_horaria_disciplina" name="carga_horaria_disciplina" placeholder=""
											value="" required>
									...
									<div class="col-md-4 mb-3">
										<label class="form-label" for="validationCustom03">Carga Horária da Reoferta
										...
										?>
										<select <?php echo $desabilitar_edicao_carga_horaria || $desabilitar_edicao ? 'readonly="readonly"' : "" ?> id="id_carga_horaria_reoferta"
											name="id_carga_horaria" class="select2 form-control" required="">
											...
											?>
											<option <?php echo isset($dados->id_carga_horaria) ? $selecionado : "" ?>
												value="<?php echo $row->id_carga_horaria ?>">
												<?php echo utf8_encode($row->carga_horaria) ?></option>
											<?php
											//}
											?>
										</select>
								...
								<div class="form-row">
									<div class="col-md-12 mb-3">
										<div class="form-group">
											...
											<select name="id_disciplina_equivalente[]" multiple="multiple"
												data-placeholder="Selecione as disciplinas equivalentes..."
												class="js-consultar-disciplina form-control">
												<?php
												if (isset($array_disciplina_equivalente)) {
													...
													while ($row = mssql_fetch_assoc($res)) {
														?>
														<option value="<?php echo trim($row['atc_cd_atividade']) ?>">
															<?php echo $row['atc_cd_atividade'] . " - " . trim(utf8_encode($row['atc_nm_atividade'])) ?>
														</option>
														<?php
													}
													?>
													<script>
														$('.js-consultar-disciplina').val(['<?php echo $array_disciplina_equivalente_select ?>']).trigger('change');
													</script>
													<?php
												}
												?>
					...
					<div class="panel-container show">
						<div class="panel-content p-0">
							<div class="panel-content">
								<div class="form-row">
									<div class="col-md-6 mb-3">
										<div class="form-group">
											...
											<select <?php echo $desabilitar_edicao ? 'disabled=""' : "" ?>
												name="id_docente" data-placeholder="Selecione o docente da disciplina"
												class="js-consultar-usuario form-control">
												<?php
								...
								<div class="form-row">
									<div class="col-md-12 mb-3">
										<div class="form-group">
											...
											<select multiple="multiple" id="id_academico_autorizado"
												name="id_academico_autorizado[]"
												data-placeholder="Selecione os acadêmicos autorizados..."
												class="js-consultar-usuario form-control">
												<?php
												if (isset($array_academico_autorizado)) {
													...
													while ($row = mssql_fetch_assoc($res)) {
														?>
														<option value="<?php echo $row['id_pessoa'] ?>">
															<?php echo $row['id_pessoa'] . " - " . trim(utf8_encode($row['nome'])) ?>
														</option>
														<?php
													}
													?>
								...
								<div class="form-row">
									<div class="col-md-12 mb-3">
										<label class="form-label" for="validationCustom02">Local da Reoferta <span
												class="text-danger">*</span></label>
										<input type="text" class="form-control" name="local" placeholder=""
											value="<?php echo isset($dados->local) ? $dados->local : "" ?>" required>
									</div>
								</div>
							</div>
						</div>
				...
				<div id="panel-2" class="panel">
					...
					<div class="panel-container show">
						<div class="panel-content p-0">
							...
							<div class="panel-content">
								<div id="cronograma_aguardando" class="alert alert-success alert-dismissible"
									style="display:<?php echo isset($_GET['id']) && $dados->id_parecer_reducao == "1" ? "" : "none" ?>;"
									role="alert">
									...
									<div class="d-flex align-items-center">
										...
										<div class="flex-1">
											...
											<p>Só é possível lançar o cronograma após a aprovação da redução de carga
												carga horária. Aguarde a aprovação!</p>
										</div>
									</div>
								</div>

								<div class="form-row" id="cronograma_container"
									style="display:<?php echo $dados->id_parecer_reducao == "1" ? "none" : "" ?>;">
									<div class="col-xl-12">
										<!-- datatable start -->
										<table id="cronograma_tabela"
								...
								if ($dados->reducao && !$dados->enviado_aprovacao_reducao) {
									...
									<div class="custom-control custom-checkbox">
										<input type="checkbox" class="custom-control-input" id="invalidCheck" value="1"
											name="enviar_aprovacao_reducao">
										<label class="custom-control-label" for="invalidCheck">Enviar para aprovação de redução
											de carga horária</label>
									</div>
									<?php
									...
									?>
										<div class="custom-control custom-checkbox" id="aprovacao_check">
											<input type="checkbox" class="custom-control-input" id="invalidCheck2" value="1"
												name="enviar_aprovacao">
	...
	if (isset($_GET['id'])) {
		if (isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][6])) {
			?>
			<iframe class="d-none" name="aprovacao_dados" src=""
				style="position: fixed; z-index: 999999999999; width: 30%; background-color: #fff; top: 0; left: 0; height: 300px"></iframe>
			<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados"
				action="modulos/reoferta/cadastro/aprovacao_dados.php">
				<input type="hidden" name="<?php echo $chave ?>" value="<?php echo $$chave ? $$chave : 0 ?>">
				<input type="hidden" name="parecer_data_reducao" value="1">
				<input type="hidden" name="id_reoferta" id="disciplina"
					value="<?php echo isset($dados->id_reoferta) ? utf8_encode($dados->id_reoferta) : "" ?>">
					...
					<div class="panel-container show">
						<div class="panel-content">
							<div class="mb-g text-center">
								<h5>Redução de
									<b><?php echo round(100 - ($dados->carga_horaria * 100 / $dados->carga_horaria_disciplina), 2) ?>%</b>
									da Carga Horária</h5>
								<div class="js-toggle-skin btn-group btn-group-toggle" data-toggle="buttons">
									<label
										class="btn btn-default <?php echo isset($dados->id_parecer_reducao) && $dados->id_parecer_reducao == 1 ? "active" : "" ?>">
									...
									<label
										class="btn btn-default <?php echo isset($dados->id_parecer_reducao) && $dados->id_parecer_reducao == 2 ? "active" : "" ?>">
									...
									<label
										class="btn btn-default <?php echo isset($dados->id_parecer_reducao) && $dados->id_parecer_reducao == 3 ? "active" : "" ?>">
										<input type="radio" name="id_parecer_reducao" value="3"
											onchange="aprovacao_indeferido()">
								...
								<div class="form-group" id="aprovacao_observacao_reducao" style="display: none;">
									...
									<textarea id="aprovacao_motivo_reducao" name="parecer_observacao_reducao" disabled=""
										class="form-control"
										rows="2"><?php echo isset($dados->parecer_observacao_reducao) ? $dados->parecer_observacao_reducao : "" ?></textarea>
								</div>
	...
	if (isset($_GET['id'])) {
		if (isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][5])) {
			...
			<iframe class="d-none" name="aprovacao_dados" src=""
				style="position: fixed; z-index: 999999999999; width: 30%; background-color: #fff; top: 0; left: 0; height: 300px"></iframe>
			<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados"
				action="modulos/reoferta/cadastro/pagamento_dados.php">
				<input type="hidden" name="<?php echo $chave ?>" value="<?php echo $$chave ? $$chave : 0 ?>">
				<input type="hidden" name="parecer_data_reducao" value="1">
				<input type="hidden" name="id_reoferta" id="disciplina"
					value="<?php echo isset($dados->id_reoferta) ? utf8_encode($dados->id_reoferta) : "" ?>">
							...
							<div class="mb-g text-center">
								<div class="form-row">
									<div class="col-md-4 mb-3 offset-4">
										<label class="form-label" for="validationCustom02">Data do Pagamento<span
												class="text-danger"></span></label>
										<input type="text" data-inputmask="'mask': '99/99/9999'" name="data_pagamento"
											class="form-control text-center" id="data_pagamento" placeholder=""
											value="<?php echo isset($dados->data_pagamento) ? converterData($dados->data_pagamento) : "" ?>">
									</div>
								</div>
								<button class="btn btn-primary ml-auto" type="submit">Salvar</button>
							</div>
						...
						<div class="panel-content">
							...
							if ($dados->enviado_aprovacao == 1) {
								...
								<div class="mb-g text-center">
									...
									<div class="js-toggle-skin btn-group btn-group-toggle" data-toggle="buttons">
										<label
											class="btn btn-default <?php echo isset($dados->id_parecer) && $dados->id_parecer == 1 ? "active" : "" ?>">
											<input type="radio" name="id_parecer" value="1" onchange="aprovacao_deferido()">
											<span class="hidden-sm-down">Aguardando</span><span class="hidden-sm-up">Opt 1</span>
										</label>
										<label
											class="btn btn-default <?php echo isset($dados->id_parecer) && $dados->id_parecer == 2 ? "active" : "" ?>">
											<input type="radio" name="id_parecer" value="2" onchange="aprovacao_deferido()">
											<span class="hidden-sm-down">Deferido</span><span class="hidden-sm-up">Opt 2</span>
										</label>
										<label
											class="btn btn-default <?php echo isset($dados->id_parecer) && $dados->id_parecer == 3 ? "active" : "" ?>">
									...
									<div class="form-group" id="aprovacao_observacao" style="display: none;">
										<label class="form-label" for="example-textarea">Motivo do Indeferimento</label>
										<textarea id="aprovacao_motivo" name="parecer_observacao" disabled="" class="form-control"
											rows="2"><?php echo isset($dados->parecer_observacao) ? utf8_encode($dados->parecer_observacao) : "" ?></textarea>
									</div>
									<button class="btn btn-primary ml-auto" type="submit">Salvar</button>
								</div>
								<?php
...
<script>
	...
	function carrega_carga_horaria_disciplina(id_disciplina = '') {
		...
		$.getJSON("modulos/reoferta/cadastro/ajax/carrega_carga_horaria_disciplina.php", {
	...
	function carrega_disciplina(id_disciplina = '') {
		...
		$.getJSON("modulos/reoferta/cadastro/ajax/carrega_disciplina.php", {
	...
	function carrega_carga_horaria_reoferta(id_disciplina = '', id_carga_horaria = '') {
		...
		$.getJSON("modulos/reoferta/cadastro/ajax/carrega_carga_horaria_reoferta.php", {
			id_curso: $("#id_curso").val()
		})
			.done(function (json) {
	...
	function carrega_periodo(id_periodo = '') {
		...
		if ($("#id_periodo").val()) {
			...
			$.getJSON("modulos/reoferta/cadastro/ajax/carrega_periodo.php", {
	...
	function carrega_disciplina_equivalente() {
		$.getJSON("modulos/reoferta/cadastro/ajax/carrega_disciplina_equivalente.php", {
			id_curso: $("#id_curso").val()
		})
			.done(function (json) {
