<?php
	...
	$sql = "SELECT
				...
				time( data_cadastro ) AS hora_cadastro,
				publicado 
			FROM
				noticia_2022 n
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							<tbody>
								...
								<tr>
									...
									<td class="pointer">
										<a style="color: #000" href="noticia/cadastro/cadastro/<?php echo $row->id_noticia?>">
									...
									<td style="width: 150px" class="text-center">
										...
										?>
											<a href="noticia/cadastro/cadastro/<?php echo $row->id_noticia?>" class="btn btn-success btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-pencil"></i></a>
										<?php
											}
