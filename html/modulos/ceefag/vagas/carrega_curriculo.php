    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><?php echo $row->fone.'-'.$row->local?></td>
          <td><?php echo $row->email ?></td>
          <?php 
          echo '$row->local';
           if($row->local == '3'){
            $url = 'https://www4.fag.edu.br/api_fhsl/uploads/'.$row->local;
           }else{
            $url = 'https://www.fag.edu.br/novo/arquivos/curriculos/'.$row->local;
           };
          ?>
          <td><h1>Teste</h1></td>
