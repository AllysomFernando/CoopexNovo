...
<ol class="breadcrumb page-breadcrumb">
	...
	<li class="breadcrumb-item active">Entrega de Meias</li>
	<li class="position-absolute pos-top pos-right d-none d-sm-block"><code>ID: 01</code></li>
</ol>
<div class="subheader">
	<h1 class="subheader-title">
		<i class='subheader-icon fal fa-barcode-read'></i> Entrega de Meias
...
$('#select2-ajax').on('select2:select', function (e) {
	...
	console.log(data.id);
	$("#titulos_em_aberto_resultado").load("modulos/tesouraria/meia/retirada/ajax/material.php?id_usuario="+data.id);
