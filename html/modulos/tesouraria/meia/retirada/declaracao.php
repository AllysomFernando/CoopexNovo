...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            ...
            <small>
                Declaração de Retirada de Meias
            </small>
        </h1>
    </div>
    <div class="container">
        <div data-size="A4">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3 class="fw-300 display-4 fw-500  keep-print-font pt-4 l-h-n m-0">
                        DECLARAÇÃO DE RETIRADA DE MEIAS BIG JUMP
                    </h3>
            ...
            <div class="row">
                <div class="p-3" style="font-size: 18px;">
                    ...
                    02.203.539/0001-73) as Meias relacionados abaixo, do aluno(a) <strong><?=utf8_encode($row['nome'])?></strong>,
