...
<main id="js-page-content" role="main" class="page-content">
	...
	<form class="needs-validation" novalidate="" method="post" target="dados" action="modulos/tesouraria/colegio/devolucao/cadastro_dados.php">
							...
							<div class="panel-content">
								...
								<div class="form-row">
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom03">Material<span class="text-danger">*</span></label>
										<?php
											$sql = "SELECT
														* 
													FROM
								...
								<div class="form-row">
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom03">Quantidade devolvida<span class="text-danger">*</span></label>
										<input name="quantidade" value="<?php echo isset($dados->quantidade) ? texto($dados->quantidade) : ""?>" type="number" class="form-control" id="quantidade" placeholder="" required>
										<div class="invalid-feedback">
											Campo obrigatório, a quantidade a ser devolvida
										</div>
									</div>
								</div>	
