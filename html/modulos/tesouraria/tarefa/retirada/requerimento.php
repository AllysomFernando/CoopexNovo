    ...
    <div class="container">
        <div data-size="A4">
            ...
            <div class="row">
                ...
                Solicito o ressarcimento em conta referente ao pagamento de Meia, por motivo de tamanho não comptaivel com a criança, a mesma utilizada para o uso do FLY/BIG JUMP no Colégio FAG. Aluno(a)  <strong><?=utf8_encode($row['nome'])?></strong>,
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table class="table mt-5">
                            <thead>
                                <tr>
                                    <th class="text-center border-top-0 table-scale-border-bottom fw-700">Quantidade</th>
                                    <th class="border-top-0 table-scale-border-bottom fw-700">Tamanho</th>
                                    <th class="text-right border-top-0 table-scale-border-bottom fw-700">Valor do Ressarcimento</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?
                                $sql2 = "SELECT
                                        ...
                                        FROM
                                            ...
                                            INNER JOIN colegio.big_jump_meia a USING ( id_pessoa ) 
                                        WHERE
                                            id_pessoa = $id_pessoa";
                                $material2 = $coopex->query($sql2);
                            ...
                            ?>
                                <tr>
                                    <td class="text-center"><?=$row2->quantidade?></td>    
                                    <td class="text-left strong"><?=$row2->material?></td>
                                    
                                    <td class="text-right"><?=$row2->total?></td>
                                </tr>
                            <?
                                }
                            ?>
