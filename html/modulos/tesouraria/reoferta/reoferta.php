...
<main id="js-page-content" role="main" class="page-content">
  <ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item active">Reoferta</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><code>ID: 02</code></li>
  </ol>
  <div class="subheader">
    <h1 class="subheader-title">
      <i class='subheader-icon fal fa-barcode-read'></i> Reoferta
      <small>
        Relatorio de recebimentos por reoferta
      </small>
    </h1>
  </div>
  <div class="row">
          ...
          <div class="panel-content">
            <div class="form-group">
              <label class="form-label" for="select2-ajax">
                Seleciona a reoferta desejada
              </label>
              <select onChange="" data-placeholder="Selecione a reoferta..." class="js-consultar-usuario form-control" id="select2-ajax"></select>
            </div>
...
<script>
  $(document).ready(function() {
    ...
    $(function() {
      ...
      $(".js-consultar-usuario").select2({
        ajax: {
          url: "modulos/_core/buscar_reoferta.php",
          dataType: 'json',
          delay: 250,
  ...
  $('#select2-ajax').on('select2:select', function(e) {
    ...
    console.log(data.id);
    $("#titulos_em_aberto_resultado").load("modulos/tesouraria/reoferta/ajax/consulta.php?reoferta=" + data.id);
