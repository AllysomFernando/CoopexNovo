...
<main id="js-page-content" role="main" class="page-content">
	...
	<form class="needs-validation" novalidate="" method="post" target="dados"
		action="modulos/tesouraria/colegio/entrada/cadastro_dados.php">
					...
					<div class="panel-container show">
						<div class="panel-content p-0">
							<div class="panel-content">
								...
								<div class="form-row">
									<div class="col-md-3 mb-3">
										...
										$sql = "SELECT
												...
												FROM
													tesouraria.material
												WHERE ano = YEAR(CURRENT_DATE) AND excluido = 0  /*TODO: verificar com o Fernando para ver se é isso mesmo*/ 
												ORDER BY
													material";

										$serie = $coopex->query($sql);
										?>
										<select onchange="mostra_quantidade()" id="id_material" name="id_material"
											...
											while ($row = $serie->fetch(PDO::FETCH_OBJ)) {
												...
												?>
												<option title="<?php echo $row->quantidade ?>" <?php echo isset($dados->id_material) ? $selecionado : "" ?>
													value="<?php echo $row->id_material ?>">
													<?php echo utf8_encode($row->material) ?></option>
												<?php
											}
											?>
										</select>
								...
								<div class="form-row">
									<div class="col-md-3 mb-3">
										<label class="form-label" for="validationCustom03">Quantidade <span
												class="text-danger">*</span></label>
										<input name="quantidade"
											value="<?php echo isset($dados->quantidade) ? texto($dados->quantidade) : "" ?>"
											type="number" class="form-control" id="quantidade" placeholder="" value=""
											required>
										<div class="invalid-feedback">
											Campo obrigatório, preencha o Material, Ex.: São Lucas - Ambulatório
										</div>
