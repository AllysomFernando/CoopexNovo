...
<main id="js-page-content" role="main" class="page-content">
	...
	<form class="needs-validation" novalidate="" method="post" target="dados" action="modulos/tesouraria/colegio/material/cadastro_dados.php">
							...
							<div class="panel-content">
								...
								<div class="form-row">
									<div class="col-md-3 mb-3">
										...
										?>	
											<option <?php echo isset($dados->id_serie) ? $selecionado : ""?> value="<?php echo $row->id_serie?>"><?php echo utf8_encode($row->serie)?></option>
										<?php
											}
										?>	
										</select>
