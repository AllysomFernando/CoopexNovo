...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            ...
            <small>
                Relatrório de Retirada por Material
            </small>
        </h1>
    </div>
    <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="border-top-0 table-scale-border-bottom fw-700"><?=utf8_encode($row_pessoa->material)?></th>
                            ...
                            <?
                                $sql2 = "SELECT
                                        ...
                                        WHERE
                                            id_material = $row_pessoa->id_material
                                        GROUP BY
                                            id_pessoa
                                        ORDER BY
                                            nome";
