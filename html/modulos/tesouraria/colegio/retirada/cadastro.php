				...
				<div class="panel-container show">
					<div class="panel-content">
						<div class="form-group">
							...
							<select onChange="" data-placeholder="Nome do aluno..."
...
<script>
	...
	$('#select2-ajax').on('select2:select', function (e) {
		...
		console.log(data.id);
		$("#titulos_em_aberto_resultado").load("modulos/tesouraria/colegio/retirada/ajax/material.php?id_usuario=" + data.id);
