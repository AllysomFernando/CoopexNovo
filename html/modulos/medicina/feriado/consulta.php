...
<form id="form_excluir_registro" method="post" target="dados" action="modulos/medicina/feriado/cadastro_dados.php">
...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title col-6">
			<i class='subheader-icon fal fa-repeat'></i> Feriados
			<small>
		...
		<div class="subheader-title col-6 text-right">
			<a href="medicina/feriado/cadastro">
					...
					<div class="panel-content">
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							<tbody>
								...
								?>
								<tr>
									<td class="pointer"><?php echo converterData($row->data_feriado)?></td>
									<td class="pointer"><?php echo texto($row->feriado)?></td>
									<td style="width: 70px">
										<?php
											if(isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][3])){
										?>
										<a href="medicina/feriado/cadastro/<?php echo $row->id_feriado?>" class="btn btn-sm btn-icon btn-outline-success rounded-circle mr-2" title="Editar Registro">
										...
										?>
										<a href="javascript:excluir_registro('medicina.feriado', 'id_feriado', <?php echo $row->id_feriado?>)" class="btn btn-sm btn-icon btn-outline-danger rounded-circle" title="Excluir Registro">
