...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title col-6">
			<i class='subheader-icon fal fa-repeat'></i> Período
			<small>
		...
		<div class="subheader-title col-6 text-right">
			<a href="medicina/periodo/cadastro">
					...
					<div class="panel-content">
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							<tbody>
								...
								?>
								<tr>
									<td class="pointer"><a href="medicina/periodo/cadastro/<?php echo $row->id_periodo?>"><?php echo texto($row->periodo)?></a></td>
									<td style="width: 70px">
										<?php
											if(isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][3])){
										?>
										<a href="medicina/periodo/cadastro/<?php echo $row->id_periodo?>" class="btn btn-sm btn-icon btn-outline-success rounded-circle mr-2" title="Editar Registro">
										...
										?>
										<a href="javascript:excluir_registro('medicina.periodo', 'id_periodo', <?php echo $row->id_periodo?>)" class="btn btn-sm btn-icon btn-outline-danger rounded-circle" title="Excluir Registro">
