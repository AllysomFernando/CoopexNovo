<?php
	...
	$sql = "SELECT
			...
			LEFT JOIN medicina.professor p ON p.id_professor = d.id_docente
			WHERE
				d.id_periodo = $periodo
			GROUP BY
				id_horario_data
			ORDER BY
				data_disponivel,
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							?>
									<tr style="background-color: <?=$row->cor?>">
										...
										<td style="vertical-align: middle;" class="pointer"><?= texto($row->id_sub_grupo)?></td>
										...
										<td style="vertical-align: middle;" align="center"><?= texto($row->grupo_aluno)?></td>
										<td style="vertical-align: middle;" align="center"><?= ($grupo)?></td>
										<td style="vertical-align: middle;" align="center"><?= texto($qtd_alunos)?></td>
										<td style="vertical-align: middle;"><?= texto($row->professor)?></td>
