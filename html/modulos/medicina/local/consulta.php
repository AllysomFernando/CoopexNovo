...
<form id="form_excluir_registro" method="post" target="dados" action="modulos/medicina/local/cadastro_dados.php">
...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		...
		<div class="subheader-title col-6 text-right">
			<a href="medicina/local/cadastro">
					...
					<div class="panel-content">
						...
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							...
							<tbody>
								...
								?>
								<tr>
									<td class="pointer"><a href="medicina/local/cadastro/<?php echo $row->id_local?>"><?php echo texto($row->local)?></a></td>
									<td style="width: 70px">
										<?php
											if(isset($_SESSION['coopex']['usuario']['permissao'][$id_menu][3])){
										?>
										<a href="medicina/local/cadastro/<?php echo $row->id_local?>" class="btn btn-sm btn-icon btn-outline-success rounded-circle mr-2" title="Editar Registro">
										...
										?>
										<a href="javascript:excluir_registro('medicina.local', 'id_local', <?php echo $row->id_local?>)" class="btn btn-sm btn-icon btn-outline-danger rounded-circle" title="Excluir Registro">
