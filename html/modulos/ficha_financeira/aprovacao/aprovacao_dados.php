...
<?php
	...
	if($_POST){
		...
		$sql = "UPDATE ficha_financeira.ficha_financeira SET id_etapa=$id_etapa WHERE (id_ficha_financeira=$id_ficha_financeira)";
		$coopex->query($sql);
		...
		if($id_etapa == 3){
			...
			$destinatario 	= $row2->id_faculdade == 1100000002 ? "academicatoledo@fag.edu.br" : "secretaria@fag.edu.br";
			$nome			= $ficha->nome;
