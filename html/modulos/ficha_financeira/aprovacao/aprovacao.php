	...
	<iframe class="d-none" name="dados" src="" style="position: fixed; z-index: 999999999999; width: 30%; background-color: #fff; top: 0; left: 0; height: 300px"></iframe>
		...
		<?
			...
			$sql_etapa = "SELECT
					...
					AND id_etapa = 4";
			$res_etapa = $coopex->query($sql_etapa);
			$nao_aprovado_academico = $res_etapa->rowCount();
											...
											<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacao/aprovacao_dados.php">
												...
												<div class="alert border-faded bg-transparent text-secondary fade show" role="alert">
		                                            <div class="d-flex align-items-center">
		                                                ...
		                                                <div class="flex-1">
		                                                    <span class="h4 color-success-600">Aprovar ficha financeira</span>
		                                                    <br>
		                                                    O valor aqui apresentado é apenas uma previsão da mensalidade, não sendo necessariamente o valor real da mensalidade.
		                                                    <br>
		                                                    <br>
		                                                    <button type="submit" class="btn btn-outline-success btn-lg btn-w-m waves-effect waves-themed">APROVAR FICHA FINANCEIRA</button>
		                                                </div>
											...
											<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacao/aprovacao_dados.php">
												...
												<div class="alert border-danger bg-transparent text-secondary fade show" role="alert">
		                                            <div class="d-flex align-items-center">
		                                                ...
		                                                <div class="flex-1">
		                                                    <span class="h4 color-danger-900">Não aprovar ficha financeira</span>
		                                                    <br>
		                                                    ...
		                                                    <button type="submit" class="btn btn-outline-danger btn-lg btn-w-m waves-effect waves-themed">NÃO APROVAR FICHA FINANCEIRA</button>
		                                                </div>
												...
												<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacao/aprovacao_dados.php">
													...
													<div class="alert border-faded bg-transparent text-secondary fade show" role="alert">
			                                            <div class="d-flex align-items-center">
			                                                ...
			                                                <div class="flex-1">
			                                                    <span class="h4 color-success-600">Ficha financeira aprovada</span>
			                                                    <br>
			                                                    Aguardando o contato da tesouraria para aprovação dos valores finais.
			                                                    <br>
		...
		<?
			} else if($nao_aprovado_academico){
		?>
			<div class="row">
				<div class="col-xl-12">
				  <div id="panel-2" class="panel">
												...
												<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacao/aprovacao_dados.php">
													...
													<div class="alert border-danger bg-transparent text-secondary fade show" role="alert">
			                                            <div class="d-flex align-items-center">
			                                                ...
			                                                <div class="flex-1">
			                                                    <span class="h4 color-danger-900">Ficha financeira não aprovada</span>
