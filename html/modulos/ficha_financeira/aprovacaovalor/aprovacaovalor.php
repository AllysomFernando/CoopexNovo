							                                ...
							                                if (mssql_num_rows($res) > 0) {
							                                  while ($row = mssql_fetch_assoc($res)) {
							                                    if ($dados->id_turma == $row['pac_id_pacote']) {
							                                      echo utf8_encode($row['pac_ds_pacote']);
							                                    }
							                                  }
							                                }
										...
										<table id="diciplinas_ficha" class="table table-bordered table-hover table-striped w-100">
											...
											?>
												<tr id="grade_montada_<?=$disciplina->atc_id_atividade?>">
													...
													<td>
						                                <select disabled id="id_turma_disciplina_<?= $disciplina->atc_id_atividade ?>" onchange="definir_turma('<?= $disciplina->atc_id_atividade ?>')" class="form-control select2">
						                                  <?
						                                  $sql10 = "SELECT
								...
								<div class="form-row" id="cronograma_container">
									...
									<!-- datatable start -->
										...
										<table id="" class="table table-bordered table-hover table-striped w-100">
											...
											<tbody>
												<tr>
													<td><input disabled="" id="pagamento1" title="1" autocomplete="off" name="valores_valor[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->parcela_1, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="pagamento2" title="2" autocomplete="off" name="valores_valor[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->parcela_2, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="pagamento3" title="3" autocomplete="off" name="valores_valor[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->parcela_3, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="pagamento4" title="4" autocomplete="off" name="valores_valor[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->parcela_4, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="pagamento5" title="5" autocomplete="off" name="valores_valor[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->parcela_5, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="pagamento6" title="6" autocomplete="off" name="valores_valor[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->parcela_6, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
												</tr>
												<tr>
													<td><strong id="convalidacao_adaptacao"><?=isset($dados->diferenca2) && $dados->diferenca2 >= 0 ? "Adaptação" : "Convalidação"?></strong></td>
													<td><input disabled="" id="diferenca2" title="2" autocomplete="off" name="valores_valor_diferenca[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->diferenca2, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="diferenca3" title="3" autocomplete="off" name="valores_valor_diferenca[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->diferenca3, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="diferenca4" title="4" autocomplete="off" name="valores_valor_diferenca[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->diferenca4, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="diferenca5" title="5" autocomplete="off" name="valores_valor_diferenca[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->diferenca5, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
													<td><input disabled="" id="diferenca6" title="6" autocomplete="off" name="valores_valor_diferenca[]" class="form-control moeda moeda_calculo" type="text" value="<?=isset($_GET['id']) ? number_format($dados->diferenca6, 2, ',', '.') : '0'?>" style="text-align: right; font-weight: bold;" data-thousands="." data-decimal=","></td>
												</tr>
											</tbody>
		...
		<?
			$sql_etapa = "SELECT
					...
					WHERE
						id_ficha_financeira = ".$_GET['id']."
					AND id_etapa = 7";
			$res_etapa = $coopex->query($sql_etapa);
			$enviado = $res_etapa->rowCount();
			...
			$sql_etapa = "SELECT
					...
					AND id_etapa = 8";
			$res_etapa = $coopex->query($sql_etapa);
			$aprovado_academico = $res_etapa->rowCount();
						...
						<div class="panel-container show">
							<div class="panel-content p-0">
								...
								<div class="panel-content">
									...
									<div class="form-row">
										<div class="col-md-12">
											<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacaovalor/aprovacao_dados.php">
												<input type="hidden" value="<?=$_GET['id']?>" name="id_ficha_financeira">
												<input type="hidden" value="8" name="id_etapa">
										...
										<div class="col-md-12 mb-3">
											<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacao/aprovacao_dados.php">
												<input type="hidden" value="<?=$_GET['id']?>" name="id_ficha_financeira">
												<input type="hidden" value="9" name="id_etapa">
												<div class="alert border-danger bg-transparent text-secondary fade show" role="alert">
		                                            <div class="d-flex align-items-center">
		                                                <div class="alert-icon">
		                                                    <span class="icon-stack icon-stack-md">
											...
											<form class="needs-validation" novalidate="" method="post" target="aprovacao_dados" action="modulos/ficha_financeira/aprovacao/aprovacao_dados.php">
												...
												<div class="alert border-faded bg-transparent text-secondary fade show" role="alert">
		                                            <div class="d-flex align-items-center">
		                                                ...
		                                                <div class="flex-1">
		                                                    <span class="h4 color-success-600">Valores da ficha financeira aprovados</span>
		                                                    <br>
		                                                    Seus boletos foram atualizados e podem ser retirados no Sagres na aba Financeiro
		                                                    <br>
...
<script>
	...
	function carrega_pacote(id_turma = ''){
		...
		$.getJSON("modulos/ficha_financeira/cadastro/ajax/disciplina_pacote.php", {id_semestre: id_semestre, id_pessoa: id_pessoa, id_periodo: id_periodo, id_curso: id_curso, id_turma: id_turma})
		.done(function(json){
