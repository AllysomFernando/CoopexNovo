<header class="page-header" role="banner">
	...
	<div class="search">
		<form class="app-forms hidden-xs-down" role="search" action="/coopex/buscar" method="post" autocomplete="off">
		...
		<div>
			...
			<div class="dropdown-menu dropdown-menu-animated dropdown-lg">
				...
				<a href="#" class="dropdown-item" data-action="app-reset">
					<span data-i18n="drpdwn.reset_layout">Redefinir Layout</span>
				</a>
				<a href="#" class="dropdown-item d-none" data-toggle="modal" data-target=".js-modal-settings">
				...
				<div class="dropdown-multilevel dropdown-multilevel-left d-none">
					...
					<div class="dropdown-menu">
						<a href="#?lang=fr" class="dropdown-item" data-action="lang" data-lang="fr">flincerti</a>
						<a href="#?lang=en" class="dropdown-item active" data-action="lang" data-lang="en">flincerti1</a>
						<a href="#?lang=es" class="dropdown-item" data-action="lang" data-lang="es">flincerti2</a>
						<div class="dropdown-divider m-0"></div>
						<a href="#?lang=ru" class="dropdown-item" data-action="lang" data-lang="ru"><span class="fal fa-plus mr-1"></span>Adicionar</a>
					</div>
				</div>
				<div class="dropdown-divider m-0"></div>
