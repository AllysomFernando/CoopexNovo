						...
						<div class="panel-content p-0">
							...
							<div class="panel-content">
								...
								<div class="form-row" id="cronograma_container">
									<div class="col-xl-12">
									<!-- datatable start -->
										<table id="cronograma_tabela2" class="table table-bordered table-hover table-striped w-100"></table>
									<!-- datatable end -->
									</div>
								</div>
							</div>
						...
						<div class="panel-content p-0">
							...
							<div class="panel-content">
								...
								<div class="form-row" id="cronograma_container">
									<div class="col-xl-12">
									<!-- datatable start -->
										<table id="cronograma_tabela3" class="table table-bordered table-hover table-striped w-100"></table>
									<!-- datatable end -->
									</div>
								</div>
							</div>
...
<script>
	...
	function carrega_carga_horaria_disciplina(id_disciplina = ''){
		...
		$.getJSON("modulos/proex/cadastro/ajax/carrega_carga_horaria_disciplina.php", {id_disciplina: id_disciplina})
		.done(function(json){
	...
	function carrega_disciplina(id_disciplina = ''){
		...
		$.getJSON("modulos/proex/cadastro/ajax/carrega_disciplina.php", {id_curso: $("#id_curso").val()})
		.done(function(json){
			$("#id_disciplina").empty();
	...
	function carrega_carga_horaria_reoferta(id_disciplina = '', id_carga_horaria = ''){
		...
		$.getJSON("modulos/proex/cadastro/ajax/carrega_carga_horaria_reoferta.php", {id_curso: $("#id_curso").val()})
		.done(function(json){
	...
	$(document).ready(function(){
		...
		var myTable2 = $('#cronograma_tabela2').dataTable(
		{
			/* check datatable buttons page for more info on how this DOM structure works */
			dom: "<'row mb-3'<'col-sm-12 col-md-6 d-flex align-items-center justify-content-start'f><'col-sm-12 col-md-6 d-flex align-items-center justify-content-end'B>>" +
				"<'row'<'col-sm-12'tr>>" +
		...
		var myTable3 = $('#cronograma_tabela3').dataTable(
		{
			/* check datatable buttons page for more info on how this DOM structure works */
			dom: "<'row mb-3'<'col-sm-12 col-md-6 d-flex align-items-center justify-content-start'f><'col-sm-12 col-md-6 d-flex align-items-center justify-content-end'B>>" +
				"<'row'<'col-sm-12'tr>>" +
