...
<main id="js-page-content" role="main" class="page-content">
  ...
  <div class="subheader">
    <h1 class="subheader-title">
      <i class='subheader-icon fal fa-barcode-read'></i> Usuários
      <small>
        Lista de usuários habilitados a acessar o sistema de medicamento no site FHSL
      </small>
    </h1>
    <div class="subheader-title col-6 text-right" id="btn_cadastro">
      <a href="fhsl/usuario/cadastro">
...
<script>
  $(document).ready(function() {
    ...
    $("#tabela_inicical").load("modulos/fhsl/usuario/ajax/carrega_usuario.php");
