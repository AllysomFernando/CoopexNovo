...
$sql = "SELECT * FROM coopex_fhsl.template where ativo = 1 ";
...
<main id="js-page-content" role="main" class="page-content">
  ...
  <div class="subheader">
    <h1 class="subheader-title">
      <i class='subheader-icon fal fa-barcode-read'></i> Relação de templates para envio

    </h1>
    <div class="subheader-title col-6 text-right" id="btn_cadastro">
      <a href="/fhsl/newslatter/templates/cadastro">
          ...
          <div class="panel-content">
            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100 dataTable dtr-inline">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><strong><?php echo $row->idTemplate?></strong></td>
                    <td><?php echo $row->nomeTemplate ?></td>
                    <td><?php echo $row->assunto ?></td>
                    
                    <td style="width: 100px" class="text-center">
                      <a href="/fhsl/newslatter/templates/cadastro/<?php echo $row->idTemplate; ?>" class="btn btn-success btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-pencil"></i></a>
                      <a href="/fhsl/newslatter/templates/envio/<?php echo $row->idTemplate; ?>" class="btn btn-dark btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-paper-plane"></i></a>
