...
if (isset($_GET['id'])) {
    $sql = "SELECT * FROM coopex_fhsl.funcao where idFuncao = :id";
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <div class="subheader-title col-6 text-right" id="btn_cadastro">
            <a href="/fhsl/newslatter/funcao/list">
            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <form class="needs-validation" novalidate="" method="post" action="modulos/fhsl/newslatter/ajax/cadastro_funcao.php">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label class="form-label" for="validationCustom02">Nome: <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="nome" placeholder="" value="<?php echo isset($dados[0]->nomeFuncao) ? $dados[0]->nomeFuncao : "" ?>" required>
                                    <input type="text" class="form-control" name="idFuncao" placeholder="" value="<?php echo isset($dados[0]->idFuncao) ? $dados[0]->idFuncao : "" ?>" hidden>
                                </div>
                            </div>
