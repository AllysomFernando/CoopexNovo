...
$sql = "SELECT * FROM coopex_fhsl.setor";
...
<main id="js-page-content" role="main" class="page-content">
  ...
  <div class="subheader">
    <h1 class="subheader-title">
      <i class='subheader-icon fal fa-barcode-read'></i> Relação de setores

    </h1>
    <div class="subheader-title col-6 text-right" id="btn_cadastro">
      <a href="/fhsl/newslatter/setor/cadastro">
          ...
          <div class="panel-content">
            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100 dataTable dtr-inline">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><strong><?php echo $row->idSetor ?></strong></td>
                    <td><?php echo $row->nomeSetor ?></td>
                    <td style="width: 100px" class="text-center">
                      <a href="/fhsl/newslatter/setor/cadastro/<?php echo $row->idSetor; ?>" class="btn btn-success btn-icon rounded-circle waves-effect waves-themed mr-2"><i class="fal fa-pencil"></i></a>
