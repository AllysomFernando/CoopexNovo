<div class="page-content header-clear-medium">
    ...
    <div class="content">
        <div class="row mb-0">
            <a href="page-chat-bubbles-2.html" class="col-4 text-center">
                <img src="images/coordenacao/valmir.jpg" width="60" class="rounded-xl" alt="img">
                <p class="font-600 color-theme">Direção</p>
            </a>
            <a href="page-chat-bubbles-2.html" class="col-4 text-center">
                <img src="images/logo.jpg" width="60" class="rounded-xl" alt="img">
                <p class="font-600 color-theme">Secretaria</p>
            </a>
            <a href="page-chat-bubbles-2.html" class="col-4 text-center">
                <img src="images/logo.jpg" width="60" class="rounded-xl" alt="img">
                <p class="font-600 color-theme">Tesouraria</p>
            </a>
        </div>
    </div>
        ...
        <div class="content mb-0">
            <div class="row mb-2 mt-n2">
                <div class="col-6 text-start">
                    <h4 class="font-700 text-uppercase font-12 opacity-50">COORDENAÇÕES</h4>
                </div>
            ...
            <a href="page-chat-bubbles-2.html" class="d-flex pb-3">
                <div class="align-self-center">
                    <img src="images/coordenacao/vanessa.jpg" width="45" class="rounded-xl me-3 border border-s" alt="img">
                </div>
                <div class="align-self-center">
                    <h5>Vanessa</h5>
                    <p class="font-500 opacity-70 mt-n2">Educação Infantil</p>
                </div>
                <div class="position-absolute end-0 pe-3">
                    <i title="Online" class="fa fa-comment font-18 color-green-dark mt-3"></i>
                </div>
            </a>
            <div class="divider mb-3"></div>
            ...
            <a href="page-chat-bubbles-2.html" class="d-flex pb-3">
                <div class="align-self-center">
                    <img src="images/coordenacao/kelly.jpg" width="45" class="rounded-xl me-3 border border-s" alt="img">
                </div>
                <div class="align-self-center">
                    <h5>Kelly</h5>
                    <p class="font-500 opacity-70 mt-n2">Ensino Fundamental I</p>
                </div>
                <div class="position-absolute end-0 pe-3">
                    <i title="Online" class="fa fa-comment font-18 color-green-dark mt-3"></i>
                </div>
            ...
            <a href="page-chat-bubbles-2.html" class="d-flex pb-3">
                <div class="align-self-center">
                    <img src="images/coordenacao/gil.jpg?a" width="45" class="rounded-xl me-3 border border-s" alt="img">
                </div>
                <div class="align-self-center">
                    <h5>Gil</h5>
                    <p class="font-500 opacity-70 mt-n2">Ensino Fundamental II (6º|8º)</p>
                </div>
                <div class="position-absolute end-0 pe-3">
                    <i title="Online" class="fa fa-comment font-18 color-green-dark mt-3"></i>
                </div>
            ...
            <a href="page-chat-bubbles-2.html" class="d-flex pb-3">
                <div class="align-self-center">
                    <img src="images/coordenacao/luiz.jpg" width="45" class="rounded-xl me-3 border border-s" alt="img">
                </div>
                <div class="align-self-center">
                    <h5>Luiz</h5>
                    <p class="font-500 opacity-70 mt-n2">Ensino Fundamental II (9º)</p>
                </div>
                <div class="position-absolute end-0 pe-3">
                    <i title="Online" class="fa fa-comment font-18 color-green-dark mt-3"></i>
                </div>
            ...
            <a href="page-chat-bubbles-2.html" class="d-flex pb-3">
                <div class="align-self-center">
                    <img src="images/coordenacao/fernanda.jpg" width="45" class="rounded-xl me-3 border border-s" alt="img">
                </div>
                <div class="align-self-center">
                    <h5>Fernanda</h5>
                    <p class="font-500 opacity-70 mt-n2">Inglês</p>
                </div>
                <div class="position-absolute end-0 pe-3">
                    <i title="Online" class="fa fa-comment font-18 color-green-dark mt-3"></i>
                </div>
            ...
            <a href="page-chat-bubbles-2.html" class="d-flex pb-3">
                <div class="align-self-center">
                    <img src="images/coordenacao/welvis.jpg" width="45" class="rounded-xl me-3 border border-s" alt="img">
                </div>
                <div class="align-self-center">
                    <h5>
                        <p class="font-14 font-600 color-theme mb-0 line-height-s">Welvis</p>
                    </h5>
                    <p class="font-500 opacity-70 mt-n2">Esportes</p>
                </div>
                <div class="position-absolute end-0 pe-3">
                    <i title="Online" class="fa fa-comment font-18 color-green-dark mt-3"></i>
                </div>
