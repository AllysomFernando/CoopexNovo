...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "Colégio FAG"; //Local Storage Names for PWA
...
function obterDataAtual() {
    ...
    var mes = pad(data.getMonth() + 1, 2); // Adiciona zero à esquerda se o mês for menor que 10
    var dia = pad(data.getDate(), 2); // Adiciona zero à esquerda se o dia for menor que 10
    return ano + '-' + mes + '-' + dia;
}
