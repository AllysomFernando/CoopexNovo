...
$.extend(true, $.fn.dataTable.defaults, {
	...
	*/
	...
	language: {
		...
		processing: '<div class="d-flex align-items-center justify-content-center fs-lg"><div class="spinner-border spinner-border-sm text-primary mr-2" role="status"><span class="sr-only"> Carregando...</span></div> Processando...</div>',
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	construct: function ()
	{
		...
		{
			this.dom.loader = $('<div class="dataTables_processing dts_loading">'+this.s.dt.oLanguage.sZeroRecords+'</div>')
				.css('display', 'none');
...
function info ( api )
{
	...
	var add = function ( el, name, num ) {
		el.append( $('<span class="select-item"/>').append( api.i18n(
			'select.'+name+'s',
			{ _: '%d '+name+'s selecionado', 0: '', 1: '1 '+name+' selecionado' },
			num
		) ) );
	};
	...
	$.each( ctx.aanFeatures.i, function ( i, el ) {
		...
		add( output, 'registro', rows );
		add( output, 'coluna', columns );
		add( output, 'celula', cells  );
		...
		altEditor.prototype,
		{
			...
			_setup: function () {
				...
				var modal = '<div class="modal fade" id="' + modal_id + '" tabindex="-1" role="dialog">' +
					...
					'<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>' + //FIXME need i18n
			...
			_openEditModal: function () {
				...
				$(selector).on('show.bs.modal', function () {
					var btns = '<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancelar</button>' +
						'<button type="button" data-content="remove" class="btn btn-primary" id="editRowBtn">Salvar</button>';
			...
			_openDeleteModal: function () {
				...
				$(selector).on('show.bs.modal', function () {
					var btns = '<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancelar</button>' +
						'<button type="button"  data-content="remove" class="btn btn-danger" id="deleteRowBtn"><i class="fal fa-times"></i> Excluir</button>';
					$(selector).find('.modal-title').html('Excluir Registro');
					$(selector).find('.modal-body').html(data);
					$(selector).find('.modal-footer').html(btns);
				});
